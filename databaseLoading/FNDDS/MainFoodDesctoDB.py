...
unparsedlines=[line.strip() for line in open('FNDDS_2011_2012/MainFoodDesc.txt')]
...
query = """INSERT INTO MainFoodDesc (id, start, end, description, fortification) VALUES (%s, %s, %s, %s, %s)"""
