##import MySQLdb
##
##db = MySQLdb.connect(host="mysql.csail.mit.edu", user="rachaeltest", passwd="test", db="nutritionData")
##cur = db.cursor()
##
print "hello world"
##
...
book = xlrd.open_workbook("ABBREV.xls")
print book.sheet_names()
sheet = book.sheet_by_name("ABBREV")


# Establish a MySQL connection
#database = MySQLdb.connect(host="mysql.csail.mit.edu", user="rachaeltest", passwd="test", db="nutritionData")
...
query = """INSERT INTO FOOD_DES_TEST (product, customer_type, rep, date, actual, expected, open_opportunities, closed_opportunities, city, state, zip, population, region) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
